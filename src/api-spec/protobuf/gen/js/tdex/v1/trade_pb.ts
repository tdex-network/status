...
class ListMarketsRequest$Type extends MessageType<ListMarketsRequest> {
  ...
  create(value?: PartialMessage<ListMarketsRequest>): ListMarketsRequest {
    ...
    if (value !== undefined) reflectionMergePartial<ListMarketsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
...
class ListMarketsResponse$Type extends MessageType<ListMarketsResponse> {
  ...
  create(value?: PartialMessage<ListMarketsResponse>): ListMarketsResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ListMarketsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: ListMarketsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.markets.length; i++)
      MarketWithFee.internalBinaryWrite(
        message.markets[i],
...
class GetMarketBalanceRequest$Type extends MessageType<GetMarketBalanceRequest> {
  constructor() {
    super('tdex.v1.GetMarketBalanceRequest', [{ no: 1, name: 'market', kind: 'message', T: () => Market }]);
  }
  create(value?: PartialMessage<GetMarketBalanceRequest>): GetMarketBalanceRequest {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetMarketBalanceRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetMarketBalanceResponse$Type extends MessageType<GetMarketBalanceResponse> {
  constructor() {
    super('tdex.v1.GetMarketBalanceResponse', [{ no: 1, name: 'balance', kind: 'message', T: () => BalanceWithFee }]);
  }
  create(value?: PartialMessage<GetMarketBalanceResponse>): GetMarketBalanceResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetMarketBalanceResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.balance)
      BalanceWithFee.internalBinaryWrite(
        message.balance,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GetMarketPriceRequest$Type extends MessageType<GetMarketPriceRequest> {
  constructor() {
    super('tdex.v1.GetMarketPriceRequest', [{ no: 1, name: 'market', kind: 'message', T: () => Market }]);
  }
  create(value?: PartialMessage<GetMarketPriceRequest>): GetMarketPriceRequest {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetMarketPriceRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetMarketPriceResponse$Type extends MessageType<GetMarketPriceResponse> {
  ...
  create(value?: PartialMessage<GetMarketPriceResponse>): GetMarketPriceResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetMarketPriceResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* double spot_price = 1; */
    if (message.spotPrice !== 0) writer.tag(1, WireType.Bit64).double(message.spotPrice);
    /* uint64 min_tradable_amount = 2; */
    if (message.minTradableAmount !== '0') writer.tag(2, WireType.Varint).uint64(message.minTradableAmount);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class PreviewTradeRequest$Type extends MessageType<PreviewTradeRequest> {
  ...
  create(value?: PartialMessage<PreviewTradeRequest>): PreviewTradeRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<PreviewTradeRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: PreviewTradeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* uint64 amount = 3; */
    if (message.amount !== '0') writer.tag(3, WireType.Varint).uint64(message.amount);
    /* string asset = 4; */
    if (message.asset !== '') writer.tag(4, WireType.LengthDelimited).string(message.asset);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class PreviewTradeResponse$Type extends MessageType<PreviewTradeResponse> {
  ...
  create(value?: PartialMessage<PreviewTradeResponse>): PreviewTradeResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<PreviewTradeResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ProposeTradeRequest$Type extends MessageType<ProposeTradeRequest> {
  ...
  create(value?: PartialMessage<ProposeTradeRequest>): ProposeTradeRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ProposeTradeRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: ProposeTradeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.swapRequest)
      SwapRequest.internalBinaryWrite(
        message.swapRequest,
...
class ProposeTradeResponse$Type extends MessageType<ProposeTradeResponse> {
  constructor() {
    super('tdex.v1.ProposeTradeResponse', [
      ...
      { no: 3, name: 'expiry_time_unix', kind: 'scalar', T: 4 /*ScalarType.UINT64*/ },
    ]);
  }
  create(value?: PartialMessage<ProposeTradeResponse>): ProposeTradeResponse {
    const message = { expiryTimeUnix: '0' };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ProposeTradeResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint64 expiry_time_unix */ 3:
          message.expiryTimeUnix = reader.uint64().toString();
          break;
        default:
          let u = options.readUnknownField;
          if (u === 'throw')
  ...
  internalBinaryWrite(
    ...
    if (message.swapAccept)
      SwapAccept.internalBinaryWrite(
        message.swapAccept,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.expiryTimeUnix !== '0') writer.tag(3, WireType.Varint).uint64(message.expiryTimeUnix);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CompleteTradeRequest$Type extends MessageType<CompleteTradeRequest> {
  ...
  create(value?: PartialMessage<CompleteTradeRequest>): CompleteTradeRequest {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CompleteTradeRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* tdex.v1.SwapComplete swap_complete */ 1:
          message.swapComplete = SwapComplete.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.swapComplete)
      SwapComplete.internalBinaryWrite(
        message.swapComplete,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class CompleteTradeResponse$Type extends MessageType<CompleteTradeResponse> {
  ...
  create(value?: PartialMessage<CompleteTradeResponse>): CompleteTradeResponse {
    const message = { txid: '' };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CompleteTradeResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* string txid = 1; */
    if (message.txid !== '') writer.tag(1, WireType.LengthDelimited).string(message.txid);
    /* tdex.v1.SwapFail swap_fail = 2; */
    if (message.swapFail)
      SwapFail.internalBinaryWrite(message.swapFail, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
...
export const TradeService = new ServiceType('tdex.v1.TradeService', [
  {
    name: 'ListMarkets',
    options: { 'google.api.http': { post: '/v1/markets' } },
    I: ListMarketsRequest,
    O: ListMarketsResponse,
  },
  {
    name: 'GetMarketBalance',
    options: { 'google.api.http': { post: '/v1/market/balance', body: '*' } },
    I: GetMarketBalanceRequest,
    O: GetMarketBalanceResponse,
  },
  {
    name: 'GetMarketPrice',
    options: { 'google.api.http': { post: '/v1/market/price', body: '*' } },
    I: GetMarketPriceRequest,
    O: GetMarketPriceResponse,
  },
  {
    name: 'PreviewTrade',
    options: { 'google.api.http': { post: '/v1/trade/preview', body: '*' } },
    I: PreviewTradeRequest,
    O: PreviewTradeResponse,
  },
  {
    name: 'ProposeTrade',
    options: { 'google.api.http': { post: '/v1/trade/propose', body: '*' } },
    I: ProposeTradeRequest,
    O: ProposeTradeResponse,
  },
  {
    name: 'CompleteTrade',
    options: { 'google.api.http': { post: '/v1/trade/complete', body: '*' } },
    I: CompleteTradeRequest,
    O: CompleteTradeResponse,
  },
]);
