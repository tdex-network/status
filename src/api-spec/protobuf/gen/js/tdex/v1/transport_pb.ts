...
class SupportedContentTypesRequest$Type extends MessageType<SupportedContentTypesRequest> {
  ...
  create(value?: PartialMessage<SupportedContentTypesRequest>): SupportedContentTypesRequest {
    ...
    if (value !== undefined) reflectionMergePartial<SupportedContentTypesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    target?: SupportedContentTypesRequest
...
class SupportedContentTypesResponse$Type extends MessageType<SupportedContentTypesResponse> {
    ...
    super('tdex.v1.SupportedContentTypesResponse', [
      {
        ...
        T: () => ['tdex.v1.ContentType', ContentType],
      },
    ]);
  }
  create(value?: PartialMessage<SupportedContentTypesResponse>): SupportedContentTypesResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SupportedContentTypesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SupportedContentTypesResponse
      ...
      switch (fieldNo) {
        case /* repeated tdex.v1.ContentType accepted_types */ 1:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.acceptedTypes.push(reader.int32());
  ...
  internalBinaryWrite(
    ...
    if (message.acceptedTypes.length) {
      ...
      for (let i = 0; i < message.acceptedTypes.length; i++) writer.int32(message.acceptedTypes[i]);
      writer.join();
    }
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
export const TransportService = new ServiceType('tdex.v1.TransportService', [
  {
    ...
    options: { 'google.api.http': { get: '/v1/transport' } },
    I: SupportedContentTypesRequest,
    O: SupportedContentTypesResponse,
  },
]);
