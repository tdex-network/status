...
class Fee$Type extends MessageType<Fee> {
  ...
  internalBinaryWrite(message: Fee, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int64 basis_point = 1; */
    if (message.basisPoint !== '0') writer.tag(1, WireType.Varint).int64(message.basisPoint);
...
class Fixed$Type extends MessageType<Fixed> {
  ...
  create(value?: PartialMessage<Fixed>): Fixed {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Fixed>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Fixed, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int64 base_fee = 1; */
    if (message.baseFee !== '0') writer.tag(1, WireType.Varint).int64(message.baseFee);
    /* int64 quote_fee = 2; */
    if (message.quoteFee !== '0') writer.tag(2, WireType.Varint).int64(message.quoteFee);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class BalanceWithFee$Type extends MessageType<BalanceWithFee> {
  ...
  create(value?: PartialMessage<BalanceWithFee>): BalanceWithFee {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<BalanceWithFee>(this, message, value);
    return message;
  }
  internalBinaryRead(
