...
export class TradeServiceClient implements ITradeServiceClient, ServiceInfo {
  ...
  getMarketBalance(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetMarketBalanceRequest, GetMarketBalanceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  getMarketPrice(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetMarketPriceRequest, GetMarketPriceResponse>('unary', this._transport, method, opt, input);
  }
  /**
   * PreviewTrade returns a counter amount and asset in response to the
   * provided ones and a trade type for a market.
