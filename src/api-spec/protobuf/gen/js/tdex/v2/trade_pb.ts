...
class GetMarketBalanceRequest$Type extends MessageType<GetMarketBalanceRequest> {
  constructor() {
    super('tdex.v2.GetMarketBalanceRequest', [{ no: 1, name: 'market', kind: 'message', T: () => Market }]);
  }
...
class GetMarketPriceRequest$Type extends MessageType<GetMarketPriceRequest> {
  constructor() {
    super('tdex.v2.GetMarketPriceRequest', [{ no: 1, name: 'market', kind: 'message', T: () => Market }]);
  }
...
class PreviewTradeRequest$Type extends MessageType<PreviewTradeRequest> {
  ...
  internalBinaryWrite(message: PreviewTradeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* string fee_asset = 5; */
    if (message.feeAsset !== '') writer.tag(5, WireType.LengthDelimited).string(message.feeAsset);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
export const TradeService = new ServiceType('tdex.v2.TradeService', [
  {
    name: 'ListMarkets',
    options: { 'google.api.http': { post: '/v2/markets' } },
    I: ListMarketsRequest,
    O: ListMarketsResponse,
  },
  {
    name: 'GetMarketBalance',
    options: { 'google.api.http': { post: '/v2/market/balance', body: '*' } },
    I: GetMarketBalanceRequest,
    O: GetMarketBalanceResponse,
  },
  {
    name: 'GetMarketPrice',
    options: { 'google.api.http': { post: '/v2/market/price', body: '*' } },
    I: GetMarketPriceRequest,
    O: GetMarketPriceResponse,
  },
  {
    name: 'PreviewTrade',
    options: { 'google.api.http': { post: '/v2/trade/preview', body: '*' } },
    I: PreviewTradeRequest,
    O: PreviewTradeResponse,
  },
  {
    name: 'ProposeTrade',
    options: { 'google.api.http': { post: '/v2/trade/propose', body: '*' } },
    I: ProposeTradeRequest,
    O: ProposeTradeResponse,
  },
  {
    name: 'CompleteTrade',
    options: { 'google.api.http': { post: '/v2/trade/complete', body: '*' } },
