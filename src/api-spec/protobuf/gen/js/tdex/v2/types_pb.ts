...
class UnblindedInput$Type extends MessageType<UnblindedInput> {
  ...
  create(value?: PartialMessage<UnblindedInput>): UnblindedInput {
    ...
    if (value !== undefined) reflectionMergePartial<UnblindedInput>(this, message, value);
    return message;
  }
  internalBinaryRead(
  ...
  internalBinaryWrite(message: UnblindedInput, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* uint32 index = 1; */
    if (message.index !== 0) writer.tag(1, WireType.Varint).uint32(message.index);
    /* string asset = 2; */
    if (message.asset !== '') writer.tag(2, WireType.LengthDelimited).string(message.asset);
    ...
    if (message.assetBlinder !== '') writer.tag(4, WireType.LengthDelimited).string(message.assetBlinder);
    /* string amount_blinder = 5; */
    if (message.amountBlinder !== '') writer.tag(5, WireType.LengthDelimited).string(message.amountBlinder);
...
class Fee$Type extends MessageType<Fee> {
  ...
  create(value?: PartialMessage<Fee>): Fee {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Fee>(this, message, value);
    return message;
  }
...
class MarketFee$Type extends MessageType<MarketFee> {
  ...
  create(value?: PartialMessage<MarketFee>): MarketFee {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<MarketFee>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: MarketFee, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.baseAsset !== '0') writer.tag(1, WireType.Varint).int64(message.baseAsset);
    /* int64 quote_asset = 2 [jstype = JS_STRING]; */
    if (message.quoteAsset !== '0') writer.tag(2, WireType.Varint).int64(message.quoteAsset);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Balance$Type extends MessageType<Balance> {
  ...
  internalBinaryWrite(message: Balance, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.baseAmount !== '0') writer.tag(1, WireType.Varint).uint64(message.baseAmount);
    /* uint64 quote_amount = 2 [jstype = JS_STRING]; */
    if (message.quoteAmount !== '0') writer.tag(2, WireType.Varint).uint64(message.quoteAmount);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Market$Type extends MessageType<Market> {
  ...
  create(value?: PartialMessage<Market>): Market {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Market>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Market, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* string base_asset = 1; */
    if (message.baseAsset !== '') writer.tag(1, WireType.LengthDelimited).string(message.baseAsset);
    /* string quote_asset = 2; */
    if (message.quoteAsset !== '') writer.tag(2, WireType.LengthDelimited).string(message.quoteAsset);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class MarketWithFee$Type extends MessageType<MarketWithFee> {
  ...
  create(value?: PartialMessage<MarketWithFee>): MarketWithFee {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<MarketWithFee>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Price$Type extends MessageType<Price> {
  ...
  create(value?: PartialMessage<Price>): Price {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Price>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Price, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.quotePrice !== 0) writer.tag(2, WireType.Bit64).double(message.quotePrice);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Preview$Type extends MessageType<Preview> {
  ...
  create(value?: PartialMessage<Preview>): Preview {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Preview>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: Preview, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.feeAmount !== '0') writer.tag(5, WireType.Varint).uint64(message.feeAmount);
    /* string fee_asset = 6; */
    if (message.feeAsset !== '') writer.tag(6, WireType.LengthDelimited).string(message.feeAsset);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
